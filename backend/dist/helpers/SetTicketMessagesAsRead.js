    ...
    try {
        ...
        if (getJsonMessage.length > 0) {
            ...
            if (lastMessages.key && lastMessages.key.fromMe === false) {
                ...
                const messageToMark = lastMessages;
                await wbot.chatModify({ markRead: true, lastMessages: [messageToMark] }, `${ticket.contact.number}@${ticket.isGroup ? "g.us" : "s.whatsapp.net"}`);
            }
        }
