...
scheduleRoutes.post("/schedules", isAuth_1.default, upload.array("file"), ScheduleController.store);
scheduleRoutes.put("/schedules/:scheduleId", isAuth_1.default, upload.array("file"), ScheduleController.update);
