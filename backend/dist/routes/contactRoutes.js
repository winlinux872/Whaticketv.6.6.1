...
contactListRoutes_1.default.post("/contacts/upload", isAuth_1.default, upload.array("file"), ContactController.upload);
...
contactRoutes.get("/contact", isAuth_1.default, ContactController.getContactVcard);
