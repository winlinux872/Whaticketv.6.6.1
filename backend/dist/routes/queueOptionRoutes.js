...
queueOptionRoutes.post("/queue-options/:queueOptionId/media-upload", isAuth_1.default, upload.array("file"), QueueOptionController.mediaUpload);
queueOptionRoutes.delete("/queue-options/:queueOptionId/media-upload", isAuth_1.default, QueueOptionController.deleteMedia);
