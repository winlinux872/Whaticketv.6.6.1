...
const backupsRoutes_1 = __importDefault(require("./backupsRoutes"));
const stickerRoutes_1 = __importDefault(require("./stickerRoutes"));
...
routes.use(geminiRoutes_1.default);
routes.use(backupsRoutes_1.default);
routes.use(stickerRoutes_1.default);
