...
const UpdateUserService = async ({ scheduleData, id, companyId, mediaPath, mediaName, }) => {
    ...
    const { body, sendAt, sentAt, contactId, ticketId, userId, geral, queueId, whatsappId, repeatEvery, selectDaysRecorrenci, repeatCount, } = scheduleData;
    try {
