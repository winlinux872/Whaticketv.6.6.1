...
const ListTicketsService = async ({ searchParam = "", pageNumber = "1", queueIds, tags, users, status, date, updatedAt, showAll, userId, withUnreadMessages, companyId }) => {
    let whereCondition = {
    ...
    includeCondition = [
        {
            ...
            as: "contact",
            attributes: ["id", "name", "number", "lid", "email", "profilePicUrl"]
        },
        {
