                ...
                if (cpfcnpj.length > 2) {
                    ...
                    if (isCPFCNPJ) {
                        ...
                        try {
                            ...
                            await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), textMessage);
                        }
                        catch (error) {
                        }
                        (0, axios_1.default)({
                            ...
                            axios_1.default.request(config)
                                ...
                                if (response.data == 'NULL') {
                                    ...
                                    try {
                                        const textMessage = { text: (0, Mustache_1.default)(`Localizei seu Cadastro! *${nome}* só mais um instante por favor!`, contact) };
                                        await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), textMessage);
                                        const bodyBoleto = { text: (0, Mustache_1.default)(`Segue a segunda-via da sua Fatura!\n\n*Nome:* ${nome}\n*Valor:* R$ ${valorCorrigido}\n*Data Vencimento:* ${anoMesDia}\n*Link:* ${urlmkauth}/boleto/21boleto.php?titulo=${titulo}\n\nVou mandar o *código de barras* na próxima mensagem para ficar mais fácil para você copiar!`, contact) };
                                        await (0, wbotMessageListener_1.sleep)(2000);
                                        await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), bodyBoleto);
                                        const bodyLinha = { text: (0, Mustache_1.default)(`${linhadig}`, contact) };
                                        await (0, wbotMessageListener_1.sleep)(2000);
                                        await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), bodyLinha);
                                        if (qrcode !== null) {
                                            const bodyPdf = { text: (0, Mustache_1.default)(`Este é o *PIX COPIA E COLA*`, contact) };
                                            await (0, wbotMessageListener_1.sleep)(2000);
                                            await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), bodyPdf);
                                            const bodyqrcode = { text: (0, Mustache_1.default)(`${qrcode}`, contact) };
                                            await (0, wbotMessageListener_1.sleep)(2000);
                                            await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), bodyqrcode);
                                        ...
                                        const bodyPdf = { text: (0, Mustache_1.default)(`Agora vou te enviar o boleto em *PDF* caso você precise.`, contact) };
                                        await (0, wbotMessageListener_1.sleep)(2000);
                                        const bodyPdfQr = { text: (0, Mustache_1.default)(`${bodyPdf}`, contact) };
                                        await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), bodyPdfQr);
                                        await (0, wbotMessageListener_1.sleep)(2000);
                                        //GERA O PDF
                                        ...
                                        if (bloqueado === 'sim') {
                                            const bodyBloqueio = { text: (0, Mustache_1.default)(`${nome} vi tambem que a sua conexão esta bloqueada! Vou desbloquear para você por *48 horas*.`, contact) };
                                            await (0, wbotMessageListener_1.sleep)(2000);
                                            await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), bodyBloqueio);
                                            const bodyqrcode = { text: (0, Mustache_1.default)(`Estou liberando seu acesso. Por favor aguarde!`, contact) };
                                            await (0, wbotMessageListener_1.sleep)(2000);
                                            await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), bodyqrcode);
                                            var optionsdesbloq = {
                                                method: 'GET',
                                            ...
                                            axios_1.default.request(optionsdesbloq).then(async function (response) {
                                                const bodyLiberado = { text: (0, Mustache_1.default)(`Pronto liberei! Vou precisar que você *retire* seu equipamento da tomada.\n\n*OBS: Somente retire da tomada.* \nAguarde 1 minuto e ligue novamente!`, contact) };
                                                await (0, wbotMessageListener_1.sleep)(2000);
                                                await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), bodyLiberado);
                                                const bodyqrcode = { text: (0, Mustache_1.default)(`Veja se seu acesso voltou! Caso nao tenha voltado retorne o contato e fale com um atendente!`, contact) };
                                                await (0, wbotMessageListener_1.sleep)(2000);
                                                await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), bodyqrcode);
                                            }).catch(async function (error) {
                                                const bodyfinaliza = { text: (0, Mustache_1.default)(`Opss! Algo de errado aconteceu! Digite *#* para voltar ao menu anterior e fale com um atendente!`, contact) };
                                                await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), bodyfinaliza);
                                            });
                                        }
                                        const bodyfinaliza = { text: (0, Mustache_1.default)(`Estamos finalizando esta conversa! Caso precise entre em contato conosco!`, contact) };
                                ...
                                .catch(async function (error) {
                                try {
                                    const bodyBoleto = { text: (0, Mustache_1.default)(`Não consegui encontrar seu cadastro.\n\nPor favor tente novamente!\nOu digite *#* para voltar ao *Menu Anterior*`, contact) };
                                    await (0, wbotMessageListener_1.sleep)(2000);
                                    await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), bodyBoleto);
                                }
                                catch (error) {
                        ...
                        const body = { text: (0, Mustache_1.default)(`Este CPF/CNPJ não é válido!\n\nPor favor tente novamente!\nOu digite *#* para voltar ao *Menu Anterior*`, contact) };
                        await (0, wbotMessageListener_1.sleep)(2000);
                        await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), body);
                    }
                }
            }
        }
                                        ...
                                        axios_1.default.request(optionsPENDING).then(async function (response) {
                                            ...
                                            axios_1.default.request(optionsGetPIX).then(async function (response) {
                                                ...
                                                if (success === true) {
                                                    ...
                                                    await (0, wbotMessageListener_1.sleep)(2000);
                                                    await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), bodyPixCP);
                                                    const bodyPix = {
                                                        text: (0, Mustache_1.default)(`${payload}`, contact),
                                                    };
                                                    await (0, wbotMessageListener_1.sleep)(2000);
                                                    await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), bodyPix);
                                                    ...
                                                    axios_1.default.request(optionsBoletopend).then(async function (response) {
                                                        ...
                                                        if (response.data?.errors?.code !== 'invalid_action') {
                                                            ...
                                                            await (0, wbotMessageListener_1.sleep)(2000);
                                                            await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), bodycodigo);
                                                            await (0, wbotMessageListener_1.sleep)(2000);
                                                            await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), bodycodigoBarras);
                                                            const bodyfinaliza = {
                                ...
                                axios_1.default.request(boleto).then(async function (response) {
                                    ...
                                    axios_1.default.request(optionsPix).then(async function (response) {
                                        ...
                                        if (tipo === 'success') {
                                            ...
                                            await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), bodyBoletoPix);
                                            const body_linhadigitavel = {
                                                text: (0, Mustache_1.default)("Este é o *Código de Barras*", contact),
                                            };
                                            await (0, wbotMessageListener_1.sleep)(2000);
                                            await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), body_linhadigitavel);
                                            await (0, wbotMessageListener_1.sleep)(2000);
                                            const body_linha_digitavel = {
                                                text: (0, Mustache_1.default)(`${linha_digitavel}`, contact),
                                            };
                                            await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), body_linha_digitavel);
                                            const body_pix = {
                                                text: (0, Mustache_1.default)("Este é o *PIX Copia e Cola*", contact),
                                            };
                                            await (0, wbotMessageListener_1.sleep)(2000);
                                            await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), body_pix);
                                            await (0, wbotMessageListener_1.sleep)(2000);
                                            const body_pix_dig = {
                                                text: (0, Mustache_1.default)(`${pix}`, contact),
                                            };
                                            await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), body_pix_dig);
                                            const body_pixqr = {
                                                        ...
                                                        if (tipo === 'sucesso') {
                                                            ...
                                                            axios_1.default.request(optionsRadius).then(async function (response) {
                                                                ...
                                                                if (tipo === 'success') {
                                                                    ...
                                                                    await (0, wbotMessageListener_1.sleep)(2000);
                                                                    await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), body_mensagem);
                                                                    const bodyPdf = {
                                                            ...
                                                            await (0, wbotMessageListener_1.sleep)(2000);
                                                            await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), bodyerro);
                                                            await (0, wbotMessageListener_1.sleep)(2000);
                                                            await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), msg_errolbieracao);
                                                            const bodyerroatendent = {
                                                                text: (0, Mustache_1.default)(`Digite *#* para voltar o menu e fale com um atendente!`, contact),
                                                            };
                                                            await (0, wbotMessageListener_1.sleep)(2000);
                                                            await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), bodyerroatendent);
                                                        }
                                                    }).catch(async function (error) {
                                                        const bodyerro = {
                                    ...
                                    if (status_internet !== 'A') {
                                        ...
                                        axios_1.default.request(optionsdesbloqeuio).then(async function (response) {
                                            ...
                                            if (tipo === 'sucesso') {
                                                ...
                                                await (0, wbotMessageListener_1.sleep)(2000);
                                                await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), bodyerroatendente);
                                            } /* else {
                                                       const bodyerro = {
                                        ...
                                        await (0, wbotMessageListener_1.sleep)(2000);
                                        await wbot.sendMessage((0, global_1.buildContactAddress)(ticket.contact, ticket.isGroup), bodysembloqueio);
                                        const bodyfinaliza = {
                                            text: (0, Mustache_1.default)(`Estamos finalizando esta conversa! Caso precise entre em contato conosco!`, contact),
                                        };
                                        await (0, wbotMessageListener_1.sleep)(2000);
