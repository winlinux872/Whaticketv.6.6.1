...
const CreateWhatsAppService = async ({ name, status = "OPENING", queueIds = [], greetingMessage, greetingMediaPath, greetingMediaName, greetingMediaSendMode = "separate", complationMessage, outOfHoursMessage, ratingMessage, isDefault = false, companyId, token = "", pix = "", pixMessage = "", provider = "beta", 
//timeSendQueue,
//sendIdQueue,
