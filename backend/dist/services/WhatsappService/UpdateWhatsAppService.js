...
const UpdateWhatsAppService = async ({ whatsappData, whatsappId, companyId }) => {
    ...
    const { name, status, isDefault, session, greetingMessage, greetingMediaPath, greetingMediaName, greetingMediaSendMode, complationMessage, outOfHoursMessage, ratingMessage, queueIds, token, pix, pixMessage, 
    //timeSendQueue,
    //sendIdQueue = null,
