...
const TicketUser_1 = __importDefault(require("./TicketUser"));
...
__decorate([
    (0, sequelize_typescript_1.HasMany)(() => TicketUser_1.default),
    __metadata("design:type", Array)
], Ticket.prototype, "ticketUsers", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsToMany)(() => User_1.default, () => TicketUser_1.default),
    __metadata("design:type", Array)
