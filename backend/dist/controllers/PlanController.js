...
exports.remove = exports.update = exports.show = exports.store = exports.register = exports.list = exports.index = void 0;
...
const FindAllPlanServiceRegister_1 = __importDefault(require("../services/PlanService/FindAllPlanServiceRegister"));
...
const register = async (req, res) => {
    const plans = await (0, FindAllPlanServiceRegister_1.default)();
    return res.status(200).json(plans);
};
