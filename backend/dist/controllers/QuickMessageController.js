...
const deleteMedia = async (req, res) => {
    ...
    try {
        ...
        const filePath = path_1.default.resolve("public", `company${companyId}`, "quick", filename);
        const fileExists = fs_1.default.existsSync(filePath);
        if (fileExists) {
            fs_1.default.unlinkSync(filePath); // Exclui o arquivo
        }
